...
const Sound = (() => {
  ...
  return {
    ...
    win() { tone(523, 0.12, 'triangle', 0.2); tone(659, 0.12, 'triangle', 0.2, 0.1); tone(784, 0.22, 'triangle', 0.2, 0.2); noise(0.2, 0.05, 7000, 0.2); },
    blackjack() { tone(523, 0.1, 'triangle', 0.22); tone(659, 0.1, 'triangle', 0.22, 0.09); tone(784, 0.1, 'triangle', 0.22, 0.18); tone(1046, 0.35, 'triangle', 0.22, 0.27); noise(0.3, 0.06, 8000, 0.27); noise(0.2, 0.05, 6000, 0.4); },
